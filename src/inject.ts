...
export const inject = (options: Ioptions) => {
    ...
    let typeormDatabaseDriverMap: Idatabasetype = {
        mssql: 'mssql', mysql: 'mysql', sqlite: 'sqlite3', cockroachdb: 'pg', postgres: 'pg',
        oracle: 'oracledb', mariadb: 'mysql'
    };
    ...
    if (options.databaseType) {
        dbTypeDriver = (typeormDatabaseDriverMap as any)[options.databaseType] as string;
